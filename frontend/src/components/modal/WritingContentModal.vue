...
function exitModal(){
    modalStore.terminate('writingContent')
}
...
<template>
    <div id="container">
        ...
        <div id="modal">
            ...
            <div id="body">
                <div id="img_upload">
                    <img id="Icon" class="IconURL" :src="contentsForm.contentIMG"
                         v-if="contentsForm.isImgIn">
                ...
                <div id="ChannelNameInputBox">
                    <div>제목</div>
                    <input type="text" id="nickName" v-model="contentsForm.title">
                    <div></div>
                    <textarea rows="5" cols="70" name="text" id="description"
                              v-model="contentsForm.context"></textarea>
                </div>
            </div>
            <div id="footer">
                <div id="btnAttend">
